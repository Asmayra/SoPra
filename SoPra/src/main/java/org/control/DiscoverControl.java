...
public class DiscoverControl {
	...
	public DiscoverControl(){
	    ...
	    DiscoverElement discover1mini = new DiscoverElement("text1", LoadImageControl.loadImageIcon("", currUser), "url1", "Album");
	    DiscoverElement discover2mini = new DiscoverElement("text2", LoadImageControl.loadImageIcon("", currUser), "url2","User");
	    DiscoverElement discover3mini = new DiscoverElement("text3", LoadImageControl.loadImageIcon("", currUser), "url3","Song");
	    ...
	    for (int i = 0; i < 12; i++) {
	    	 DiscoverElement discover = new DiscoverElement("Künstler "+(i+1), LoadImageControl.loadImageIcon("", currUser), "url "+i,"User");
	    	 artists.add(discover);
		}
	    for (int i = 0; i < 126 ;i++) {
	    	 DiscoverElement discover = new DiscoverElement("Lied "+(i+1), LoadImageControl.loadImageIcon("", currUser), "url "+i,"Song");
	    	 songs.add(discover);
		}
	    for (int i = 0; i < 15; i++) {
	    	 DiscoverElement discover = new DiscoverElement("Album "+(i+1), LoadImageControl.loadImageIcon("", currUser), "url "+i,"Album");
	    	 albums.add(discover);
		}
