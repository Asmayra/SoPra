...
public class DiscoverControl {
	...
	public DiscoverControl(){
	    ...
	    DiscoverElement discover1mini = new DiscoverElement("text1", LoadImageControl.loadImageIcon(""), "url1");
	    DiscoverElement discover2mini = new DiscoverElement("text2", LoadImageControl.loadImageIcon(""), "url2");
	    DiscoverElement discover3mini = new DiscoverElement("text3", LoadImageControl.loadImageIcon(""), "url3");
	    ...
	    for (int i = 0; i < 12; i++) {
	    	 DiscoverElement discover = new DiscoverElement("Künstler "+(i+1), LoadImageControl.loadImageIcon(""), "url "+i);
	    	 artists.add(discover);
		}
	    for (int i = 0; i < 126 ;i++) {
	    	 DiscoverElement discover = new DiscoverElement("Lied "+(i+1), LoadImageControl.loadImageIcon(""), "url "+i);
	    	 songs.add(discover);
		}
	    for (int i = 0; i < 15; i++) {
	    	 DiscoverElement discover = new DiscoverElement("Album "+(i+1), LoadImageControl.loadImageIcon(""), "url "+i);
	    	 albums.add(discover);
		}
